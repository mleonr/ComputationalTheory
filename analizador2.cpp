...
void swcase(string cad,map<string,int> &result){
	...
	if(cad=="p") ans="web";
	else if(cad=="z") ans="webpage";
	else if(cad=="aa") ans="ebay";	
	else if(cad=="bb") ans="email";
	else if(cad=="ii") ans="easy";
	else if(cad=="oo") ans="each";
	else if(cad=="ss") ans="amazon";
	else if(cad=="vv") ans="facebook";
	else if(cad=="xx") ans="twitter";
